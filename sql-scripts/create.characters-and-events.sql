...
CREATE TABLE IF NOT EXISTS characters (
  character_owner varchar(80) REFERENCES accounts(account_id),
...
CREATE TABLE IF NOT EXISTS portfolios (
  ...
  portfolio_owner varchar(80) REFERENCES characters(character_id),
...
CREATE TABLE IF NOT EXISTS skills (
  ...
  skills_owner varchar(80) REFERENCES characters(character_id),
...
CREATE TABLE IF NOT EXISTS stats (
  ...
  stats_owner varchar(80) REFERENCES characters(character_id),
